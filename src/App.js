      ...
      <section className = "App-sessao-conhecimentos">
        ...
        <div className = 'App-conhecimentos'>
          ...
          <div className = 'App-conhecimento'>
            ...
            <div className = 'App-conhecimento-text'>
              <p>Linguagem aprendida principalmente durante o curso de graduação voltada para inteligência articial e ciência de dados</p>
            </div>
          </div>
          <div className = 'App-conhecimento'>
            <div className = 'App-conhecimento-header'>
            ...
            <div className = 'App-conhecimento-text'>
              <p>Aprendida principalmente nos cursos de banco de dados e laboratório de banco de dados</p>
            </div>
          </div>
          <div className = 'App-conhecimento'>
            <div className = 'App-conhecimento-header'>
            ...
            <div className = 'App-conhecimento-text'>
              <p>Podemos confirmar a linguagem C como mais ou menos 80% do curso de engenharia, me acompanhando durante toda a jornada de graduação</p>
            </div>
          </div>
          <div className = 'App-conhecimento'>
            <div className = 'App-conhecimento-header'>
            ...
            <div className = 'App-conhecimento-text'>
              <p>Confesso que não possuía muito domínio em relação a versionamento de códigos, porém no ultimo ano de faculdade comecei a me especializar um pouco mais e desde então ficar sem github é algo inviável para um programador</p>
            </div>
          </div>
          <div className = 'App-conhecimentos-img-wrapper'>
            <img src = 'https://proj4.me/wp-content/uploads/2020/10/Livros-gerenciamento-de-Projetos-768x528.png' alt = ''></img>
          </div>
